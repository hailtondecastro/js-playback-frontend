...
export interface IJsHbSession {
    ...
    /**
     * Process the response body literal object getted from backend.<br>
     * Body format: { result: any }.<br>
     * Creates all the {@link ./lazy-ref#LazyRefMTO} and {@link ./lazy-ref#LazyRefOTM} for the L instance.<br>
     * it call {@link #storeOriginalLiteralEntry)} for a future {@link this#restoreEntireStateFromLiteral}.<br>
     * 
     * @param entityType 
    ...
    /**
     * Process the response body literal for each object getted from backend.<br>
     * Body format: { result: Array<any> }.<br>
     * Creates all the {@link ./lazy-ref#LazyRefMTO} and {@link ./lazy-ref#LazyRefOTM} for the L instance.<br>
     * it call {@link #storeOriginalLiteralEntry)} for a future {@link this#restoreEntireStateFromLiteral}.<br>
     *
     * @template L
     * @param {Type<L>} entityType
     * @param {{result: any}} literalJsHbResult
     * @returns {Array<L>}
     * @memberof IJsHbSession
     */
     ...
     * Creates all the {@link ./lazy-ref#LazyRefMTO} and {@link ./lazy-ref#LazyRefOTM} for the T instance.<br>
     * 
     * @template T
    ...
    /**
     * Start recording for all modifications on entity objects returned.<br>
     * 
     * See: {@link this#getLastRecordedPlayback}<br>
     * See: {@link this#getLastRecordedPlaybackAsLiteral}<br>
     *
     * @memberof IJsHbSession
     */
    startRecording(): void;
    /**
     * Stop recording for all modifications on entity objects returned.<br>
     * 
     * See: {@link this#getLastRecordedPlayback}<br>
     * See: {@link this#getLastRecordedPlaybackAsLiteral}<br>
     *
    ...
    /**
     * Get the managed instance for literalRef<br>
     * 
     * See: {@link this#generateEntireStateAsLiteral}<br>
     * See: {@link this#restoreEntireStateFromLiteral}<br>
     * See: {@link this#createLiteralRefForEntity}<br>
     *
     * @template T
     * @param {*} literalRef
     * @returns {T}
