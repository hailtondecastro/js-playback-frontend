...
export function base64urlDecode(value: any, encoding: any): any;
export function base64urlEncode(value: any, encoding: any): any;
export function decode(buffer: any): any;
export function encode(buffer: any): any;
